        ...
        var n = e("tslib"),
          o = (function(e) {
            function t(t, r, n) {
              ...
              return (
                (o.name = "LoggingError"), (o.code = t), (o.status = n || 0), o
              );
            }
      ...
      function(e, t, r) {
        ...
        r.parseUA = function(e, t) {
          ...
          var d = "version" === p[1] ? p[3] : p[1],
            ...
            y = {
              name:
                null !== (i = null == d ? void 0 : d.toString()) && void 0 !== i
                  ? i
                  : "unknown",
              version:
                null !== (a = null == g ? void 0 : g.toString()) && void 0 !== a
                  ? a
                  : "unknown",
              platform: c,
            };
          ...
          return (function() {
            ...
            return (
              ...
              (t.prototype._onEvent = function(e) {
                this._getListeners(a.HumanizedEvents[e.name]).forEach(function(
                  t
                ) {
                  t(e.eventData);
                });
              ...
              (t.prototype._onGetToken = function(e, t) {
                ...
                if ("function" == typeof n)
                  ...
                  if (
                    !this._getListeners(a.HumanizedEvents.PLAYER_INIT_ERROR)
                      .length
                  )
